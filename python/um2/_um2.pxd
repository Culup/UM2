...
cdef extern from "um2c.h":
    ...
    Int um2MaterialNumNuclides(void * material)

    void um2MaterialSetName(void * material)

    const char * um2MaterialGetName(void * material)

    void um2MaterialPopulateXSec(void * materal)
